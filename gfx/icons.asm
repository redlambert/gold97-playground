...
CruizeIcon:       INCBIN "gfx/icons/cruize.2bpp"
AqualloIcon:      INCBIN "gfx/icons/aquallo.2bpp"
FeraligatrIcon:   INCBIN "gfx/icons/feraligatr.2bpp"
TangtripIcon:     INCBIN "gfx/icons/tangtrip.2bpp"
...
ParamiteIcon:     INCBIN "gfx/icons/paramite.2bpp"
...
ChixIcon:         INCBIN "gfx/icons/chix.2bpp"
